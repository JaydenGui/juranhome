...
public class Api {
    ...
    */
    ...
    public static String GETMEMBERNEEDS(String memberId,String status , int offset , int limit){
    	return DESIGNPATH+"/v1/api/member/"+memberId+"/needs?offset="+offset+"&limit="+limit+"&media_type_id=53&sort_by=date&sort_order=desc";
    }
    /**
    ...
    */
    ...
    public static final String BEISHUORDER(String member_id,int page,int pageSize){
    	return DESIGNPATH+"/v1/api/beishu/"+member_id+"/needs?offset="+page+"&limit="+pageSize+"&media_type_id=53&sort_by=date&sort_order=desc";
    }
    ...
    public static final String ALIPAY(String order_id,String orderLine_Id){
    	return DESIGNPATH+"/v1/api/pay/alipay/web/path?orderId="+order_id+"&orderLineId="+orderLine_Id+"&channel_type=web&paymethod=1";
    }
