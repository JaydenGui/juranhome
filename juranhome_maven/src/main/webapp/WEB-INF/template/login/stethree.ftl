    ...
    <div id="center">
        ...
        <div class="regsitera" id="account">
            ...
            <div class="contact_zhuce caasi">
                <form name="form1" action="${baseUrl}/login/stefour" method="post" ng-submit="submit($event)" class="ng-pristine ng-invalid ng-invalid-required">
                    <input type="hidden" id="type" name="type" ng-model="userLoginType" class="ng-pristine ng-valid">
                    <ul>
                        <li>
                            <p>输入密码:</p><input class="hsinv" name="yourpass" style="width: 75%" type="password" id="verifypasswor"  onblur="verifypassword()" required autocomplete="off" ng-model="phone" class="ng-pristine ng-invalid ng-invalid-required">
                            <span class="tips" id="passwor"></span>
                        </li>
                        <li>
                            <p>确认密码:</p><input class="hsinv"  name="pass" style="width: 75%;" type="password" id="verifypasswordt"  onblur="verifypasswordtow()" required autocomplete="off" ng-model="phone" class="ng-pristine ng-invalid ng-invalid-required">
                            <span class="tips" id="verifyp"></span>
                        </li>
                    </ul>
