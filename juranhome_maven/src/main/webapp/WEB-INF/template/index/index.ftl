...
<!DOCTYPE html>
<html ng-app="app" id="ng-app" ng-cloak ng-init="userType==false">
  ...
  <body ng-controller="ctrl">
    ...
    <div style="height: 88px; display: block;">
      <div style="position: position; z-index: 999999999;">
    ...
    <div id="slides">
      <ul class="slides-container" style="top: 7px;">
        ...
        <li>
          ...
          <div class="container" style="position: relative" id="contwe">
            <ul class="viewFrame">
              <li>
                <h3 class="p01title">选“最优”的设计师</h3></li>
              <li>
                <p class="p01p">服务真诚&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;经验丰富&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;理念创新</p></li>
              <li>
                <iframe src="${baseUrl}/index3d" class="p01iframe" width="100%" scrolling="no" allowtransparency="true" frameborder="0"></iframe>
              </li>
              <li>
                <div class="caselibraryframe">
                  <a href="${baseUrl}/designer/index/" class="caselibrarybn"></a>
                </div>
              </li>
            </ul>
          </div>
      ...
      <nav class="slides-navigation">
        <a href="javascript:void(0);" class="next">
          <i class="">
            <img style="position: absolute; bottom: 9px; display: block; left: 12px;" src="${baseUrl}/images/index/next_03.png" alt=""></i>
          <!-- icon-chevron-right --></a>
        <a href="javascript:void(0);" class="prev">
          <i class="">
            <img style="position: absolute; bottom: 9px; display: block; right: 15px;" src="${baseUrl}/images/index/next_06.png" alt=""></i>
        </a>
      </nav>
      ...
      <div id="footer" style="display: none; position: fixed; bottom: 0px; left: 0; z-index: 10000; width: 100%;">
        <#include '/common/footer.html'/></div>
      <!--footer-->
