  ...
  var updateDeselectedThread=function(message){
    ...
    **/
    var showMessage=function(message){
		...
		messageTab += "' >";
		messageTab += "<div class='avatar'><img src='img/photo.jpg' alt=''/></div>";
    ...
    **/
    var addRecipient=function(){
		...
		//Add by Blair 2015-12-25 ==================================================================================== Start
    	var recipient_id_input=TargetID;
		//Add by Blair 2015-12-25 ==================================================================================== End
...
var StartTalk = function() {
	...
	//alert(ChannelReady);
	//Chat.addRecipient();
	setTimeout("Chat.addRecipient()", 1000);
}
