...
(function() {
    ...
    if (s) {
        ...
        v.readyState ? v.onreadystatechange = function() {
            if ("loaded" == v.readyState || "complete" == v.readyState) v.onreadystatechange = null,
            loadHtml5Gallery(w)
        }: v.onload = function() {
            loadHtml5Gallery(w)
        };
...
function loadHtml5Gallery(s) {
    ...
    jQuery.extend(jQuery.easing, {
        ...
        easeInOutQuint: function(b, e, a, d, c) {
            return 1 > (e /= c / 2) ? d / 2 * e * e * e * e * e + a: d / 2 * ((e -= 2) * e * e * e * e + 2) + a
        },
        ...
        easeOutElastic: function(b, e, a, d, c) {
            b = 1.70158;
            var k = 0,
            f = d;
            if (0 == e) return a;
        ...
        easeInOutElastic: function(b, e, a, d, c) {
            ...
            k || (k = c * 0.3 * 1.5);
            f < Math.abs(d) ? (f = d, b = k / 4) : b = k / (2 * Math.PI) * Math.asin(d / f);
            return 1 > e ? -0.5 * f * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * c - b) * 2 * Math.PI / k) + a: 0.5 * f * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * c - b) * 2 * Math.PI / k) + d + a
        },
        ...
        easeOutBounce: function(b, e, a, d, c) {
            return (e /= c) < 1 / 2.75 ? d * 7.5625 * e * e + a: e < 2 / 2.75 ? d * (7.5625 * (e -= 1.5 / 2.75) * e + 0.75) + a: e < 2.5 / 2.75 ? d * (7.5625 * (e -= 2.25 / 2.75) * e + 0.9375) + a: d * (7.5625 * (e -= 2.625 / 2.75) * e + 0.984375) + a
        },
    ...
    w.fn.touchSwipe = function(b) {
        ...
        return this.each(function() {
            function a(a) {
                ...
                1 <= b.targetTouches.length ? (f = b.targetTouches[0].pageX, h = b.targetTouches[0].pageY) : k(a)
            }
            function b(a) {
            ...
            function c(a) {
                if (0 < j || 0 < g) 100 < Math.abs(j - f) && (j > f ? e.swipeRight && e.swipeRight.call() : e.swipeLeft && e.swipeLeft.call()),
            ...
            g = -1;
            try {
                w(this).bind("touchstart", a),
                w(this).bind("touchmove", b),
                w(this).bind("touchend", c),
                w(this).bind("touchcancel", k)
            } catch(S) {}
        })
    };
    var m = jQuery;
    ...
    q = x.drag = {
        ...
        livekey: "livedrag",
        add: function(b) {
            var e = m.data(this, q.datakey),
            a = b.data || {};
            e.related += 1; ! e.live && b.selector && (e.live = !0, v.add(this, "draginit." + q.livekey, q.delegate));
            m.each(q.defaults,
            function(b) {
                void 0 !== a[b] && (e[b] = a[b])
            })
        ...
        teardown: function() {
            m.data(this, q.datakey).related || (m.removeData(this, q.datakey), v.remove(this, "mousedown", q.init), v.remove(this, "draginit", q.delegate), q.textselect(!0), this.detachEvent && this.detachEvent("ondragstart", q.dontstart))
        },
        init: function(b) {
            var e = b.data,
            a;
            if (! (0 < e.which && b.which != e.which) && !m(b.target).is(e.not) && (!e.handle || m(b.target).closest(e.handle, b.currentTarget).length)) if (e.propagates = 1, e.interactions = [q.interaction(this, e)], e.target = b.target, e.pageX = b.pageX, e.pageY = b.pageY, e.dragging = null, a = q.hijack(b, "draginit", e), e.propagates) {
                if ((a = q.flatten(a)) && a.length) e.interactions = [],
                m.each(a,
                function() {
                    e.interactions.push(q.interaction(this, e))
                });
                e.propagates = e.interactions.length; ! 1 !== e.drop && x.drop && x.drop.handler(b, e);
                q.textselect(!1);
        ...
        handler: function(b) {
            var e = b.data;
            switch (b.type) {
            case ! e.dragging && "mousemove": if (Math.pow(b.pageX - e.pageX, 2) + Math.pow(b.pageY - e.pageY, 2) < Math.pow(e.distance, 2)) break;
                b.target = e.target;
            ...
            case "mouseup":
                v.remove(document, "mousemove mouseup", q.handler),
                e.dragging && (!1 !== e.drop && x.drop && x.drop.handler(b, e), q.hijack(b, "dragend", e)),
                q.textselect(!0),
        ...
        delegate: function(b) {
            var e = [],
            a,
            d = m.data(this, "events") || {};
            m.each(d.live || [],
            function(c, d) {
                if (0 === d.preType.indexOf("drag") && (a = m(b.target).closest(d.selector, b.currentTarget)[0])) v.add(a, d.origType + "." + q.livekey, d.origHandler, d.data),
                0 > m.inArray(a, e) && e.push(a)
            });
            return ! e.length ? !1 : m(e).bind("dragend." + q.livekey,
            function() {
        ...
        hijack: function(b, e, a, d, c) {
            if (a) {
                ...
                a.results = [];
                do
                if ((t = a.interactions[g]) && !("dragend" !== e && t.cancelled)) p = q.properties(b, a, t),
                t.results = [],
                m(c || t[h] || a.droppable).each(function(c, d) {
                    j = (p.target = d) ? v.handle.call(d, b, p) : null; ! 1 === j ? ("drag" == h && (t.cancelled = !0, a.propagates -= 1), "drop" == e && (t[h][c] = null)) : "dropinit" == e && t.droppable.push(q.element(j) || d);
                    "dragstart" == e && (t.proxy = m(q.element(j) || t.drag)[0]);
                    t.results.push(j);
                    delete b.result;
                    if ("dropinit" !== e) return j
                }),
                a.results[g] = q.flatten(t.results),
                "dropinit" == e && (t.droppable = q.flatten(t.droppable)),
                "dragstart" == e && !t.cancelled && p.update();
                while (++g < d);
                b.type = f;
                b.originalEvent = k;
    ...
    q.callback.prototype = {
        update: function() {
            x.drop && this.available.length && m.each(this.available,
            function(b) {
    ...
    B.fn.html5boxTransition = function(b, e, a, d, c) {
        ...
        "fade" == j || "fadein" == j ? (a.hide(), e.insertBefore(a), a.fadeIn(f, k,
        function() {
            e.remove();
            c()
        })) : "fadeout" == j ? (a.show(), e.fadeOut(f, k,
        function() {
            e.remove();
            c()
        })) : "fadeinout" == j ? (a.hide(), e.insertBefore(a), e.fadeOut(f, k), a.fadeIn(f, k,
        function() {
            e.remove();
            c()
        })) : "crossfade" == j ? (a.hide(), e.fadeOut(f / 2, k,
        function() {
            a.fadeIn(f / 2, k,
            function() {
                e.remove();
    ...
    l.fn.addHTML5VideoControls = function(b, e, a) {
        ...
        if (!q && (n.get(0).requestFullscreen || n.get(0).webkitRequestFullScreen || n.get(0).mozRequestFullScreen || n.get(0).webkitEnterFullScreen || n.get(0).msRequestFullscreen)) {
            ...
            !1);
            n.get(0).addEventListener("webkitbeginfullscreen",
            function() {
                t = !0
            },
            !1);
            n.get(0).addEventListener("webkitendfullscreen",
            function() {
                t = !1
            },
            !1);
        ...
        function() {
            ...
            a ? q || n.get(0).pause() : n.get(0).play()
        });
        a = n.get(0).volume;
    ...
    b.fn.html5gallery = function(l) {
        ...
        e.prototype = {
            ...
            initData: function(a) {
                ...
                this.options.youtubechannel.author ? d.author = this.options.youtubechannel.author: this.options.youtubechannel.q && (d.q = this.options.youtubechannel.q), d = "https://gdata.youtube.com/feeds/api/videos?" + b.param(d), c = this, b.getJSON(d,
                function(b) {
                    ...
                    c.readTags();
                    a(c)
                })) : this.options.youtubeapikey && this.options.youtubeplaylistid ? (c = this, this.getYouTubePlaylist(this.options.youtubeapikey, this.options.youtubeplaylistid, this.options.youtubeplaylistmaxresults, -1,
                function() {
                    c.readTags();
                    a(c)
                },
            ...
            getYouTubePlaylist: function(a, d, c, e, f, h, j) {
                ...
                function(b) {
                    if (b && b.items) for (var g = 0; g < b.items.length; g++) {
                        ...
                        j = [g, "https://img.youtube.com/vi/" + j + "/0.jpg", "https://www.youtube.com/embed/" + j, null, null, null, null, b.items[g].snippet.title, b.items[g].snippet.description, 9, 640, 480, l, null, null, null, null];
            ...
            processElemArray: function(a) {
                for (var b = !1,
                c = 0; c < a.elemArray.length; c++) if (13 == a.elemArray[c][9] && a.elemArray[c][19] && a.elemArray[c][20]) {
                    b = !0;
                    break
                }
            ...
            createSocialMedia: function() {
                ...
                this.options.showsocialmedia && this.options.showtwitter && (d = "<div style='display:block; float:left; width:110px; height:21px;'><a href='https://twitter.com/share' class='twitter-share-button'", d = this.options.twitterurl && 0 < this.options.twitterurl.length ? d + (" data-url='" + this.options.twitterurl + "'") : d + (" data-url='" + a + "'"), this.options.twitterusername && 0 < this.options.twitterusername.length && (d += " data-via='" + this.options.twittervia + "' data-related='" + this.options.twitterusername + "'"), b(".html5gallery-viral-" + this.id, this.$gallery).append(d + ">Tweet</a></div>"), b.getScript("https://platform.twitter.com/widgets.js"));
            ...
            createEvents: function() {
                ...
                b(".html5gallery-box-" + this.id, this.$gallery).mousemove(function() {
                    if ("mouseover" == a.options.imagetoolboxmode) {
                        var b = a.elemArray[a.curElem][9]; ("always" == a.options.showimagetoolbox || "image" == a.options.showimagetoolbox && 1 == b) && a.showimagetoolbox(b, !0)
                    }
                });
                b(".html5gallery-box-" + this.id, this.$gallery).hover(function() {
                    a.onSlideshowOver();
                    if ("mouseover" == a.options.imagetoolboxmode) {
                        var b = a.elemArray[a.curElem][9]; ("always" == a.options.showimagetoolbox || "image" == a.options.showimagetoolbox && 1 == b) && a.showimagetoolbox(b)
                    }
                },
                function() {
                ...
                b(".html5gallery-car-slider-" + this.id, this.$gallery).bind("drag",
                function(b, d) {
            ...
            resizeStyleVertical: function() {
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    this.options.carouselSlider = Math.floor(this.options.carAreaLength / (this.options.thumbheight + this.options.thumbgap)) < this.elemArray.length,
                    this.options.carouselSlider && (this.options.carouselWidth += 20, this.options.width -= 20, this.options.boxWidth = this.options.width, this.options.slideshadow && (this.options.boxWidth += 8)),
                    "left" == this.options.carouselposition ? (this.options.boxLeft = this.options.padding + this.options.carouselWidth + this.options.carouselmargin, this.options.carouselLeft = this.options.padding) : this.options.carouselLeft = this.options.padding + this.options.width + this.options.carouselmargin,
                    ...
                    e = this.options.isIPhone ? c - 48 : c,
            ...
            createStyleVertical: function() {
                ...
                this.options.isIE7 || this.options.isIE6 ? (c += " .html5gallery-loading-" + this.id + " {display:none; }", c += " .html5gallery-loading-center-" + this.id + " {display:none; }") : (c += " .html5gallery-loading-" + this.id + " {display:block; position:absolute; top:4px; right:4px; width:100%; height:100%; background:url('" + this.options.skinfolder + "loading.gif') no-repeat top right;}", c += " .html5gallery-loading-center-" + this.id + " {display:block; position:absolute; top:0px; left:0px; width:100%; height:100%; background:url('" + this.options.skinfolder + "loading_center.gif') no-repeat center center;}");
                ...
                this.carouselBarClicked = function(a) {
                    ...
                    a.pageY > b(".html5gallery-car-slider-" + this.id, this.$gallery).offset().top ? (a = -1 * parseInt(d.css("margin-top")) + this.options.thumbShowNum * (this.options.thumbheight + this.options.thumbgap), a >= this.options.thumbTotalHeight - this.options.thumbMaskHeight && (a = this.options.thumbTotalHeight - this.options.thumbMaskHeight)) : (a = -1 * parseInt(d.css("margin-top")) - this.options.thumbShowNum * (this.options.thumbheight + this.options.thumbgap), 0 > a && (a = 0));
                    d.stop(!0).animate({
                        marginTop: -a
                    },
                    500);
            ...
            createImageToolbox: function() {
                ...
                this.showimagetoolbox = function(a, d) {
                    if (this.options.showplaybutton || this.options.showprevbutton || this.options.shownextbutton || this.options.showfullscreenbutton) {
                        ...
                        this.options.showfullscreenbutton && 1 == a ? b(".html5gallery-lightbox-" + this.id, this.$gallery).show() : b(".html5gallery-lightbox-" + this.id, this.$gallery).hide();
            ...
            resizeStyleDefault: function() {
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    f = this.options.isIPhone ? e - 48 : e,
                    b(".html5gallery-elem-video-container-" + this.id).find("video").css({
                        width: a + "px",
                        height: f + "px"
                    }),
                    ...
                    b("#html5gallery-elem-video-" + this.id).attr("width", a),
                    b("#html5gallery-elem-video-" + this.id).attr("height", e),
                    b(".html5gallery-elem-video-" + this.id).find("iframe").attr("width", a),
                    b(".html5gallery-elem-video-" + this.id).find("iframe").attr("height", e),
                    b("#html5gallery-elem-video-" + this.id).find("iframe").attr("width", a),
                    b("#html5gallery-elem-video-" + this.id).find("iframe").attr("height", e);
                    f = a = 0;
                    ...
                    }), this.options.carouselNavButton = !1, Math.floor((this.options.width - 4 - 4) / (this.options.thumbwidth + this.options.thumbgap)) < this.elemArray.length && (this.options.carouselNavButton = !0), a = this.options.carouselNavButton ? 2 * this.options.carouselarrowwidth + 8 : 0, b(".html5gallery-car-left-" + this.id).css({
            ...
            createStyleDefault: function() {
                ...
                this.options.isIE7 || this.options.isIE6 ? (a += " .html5gallery-loading-" + this.id + " {display:none; }", a += " .html5gallery-loading-center-" + this.id + " {display:none; }") : (a += " .html5gallery-loading-" + this.id + " {display:block; position:absolute; top:4px; right:4px; width:100%; height:100%; background:url('" + this.options.skinfolder + "loading.gif') no-repeat top right;}", a += " .html5gallery-loading-center-" + this.id + " {display:block; position:absolute; top:0px; left:0px; width:100%; height:100%; background:url('" + this.options.skinfolder + "loading_center.gif') no-repeat center center;}");
                ...
                this.options.showcarousel && this.options.carouselmultirows ? (a += " .html5gallery-car-" + this.id + " { position:absolute; display:block; overflow:hidden; left:" + this.options.carouselLeft + "px; top:" + this.options.carouselTop + "px; width:" + this.options.width + "px;", a = this.options.carouselbgtransparent ? a + "background-color:transparent;": a + ("border-top:1px solid " + this.options.carouseltopborder + ";border-bottom:1px solid " + this.options.carouselbottomborder + ";background-color: " + this.options.carouselbgcolorend + "; background: " + this.options.carouselbgcolorend + " -webkit-gradient(linear, left top, left bottom, from(" + this.options.carouselbgcolorstart + "), to(" + this.options.carouselbgcolorend + ")) no-repeat; background: " + this.options.carouselbgcolorend + " -moz-linear-gradient(top, " + this.options.carouselbgcolorstart + ", " + this.options.carouselbgcolorend + ") no-repeat; filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=" + this.options.carouselbgcolorstart + ", endColorstr=" + this.options.carouselbgcolorend + ") no-repeat; -ms-filter: 'progid:DXImageTransform.Microsoft.gradient(startColorstr=" + this.options.carouselbgcolorstart + ", endColorstr=" + this.options.carouselbgcolorend + ")' no-repeat;"), this.options.carouselbgimage && (a += "background:url('" + this.options.skinfolder + this.options.carouselbgimage + "') center top;"), d = Math.floor(this.options.width / (this.options.thumbwidth + this.options.thumbgap)), 1 > d && (d = 1), d = (this.options.width - d * this.options.thumbwidth - (d - 1) * this.options.thumbgap) / 2, a = a + "}" + (".html5gallery-thumbs-" + this.id + " { position:relative; display:block; margin-left:" + d + "px; width:" + ("samecolumn" == this.options.thumbresponsive ? (this.options.thumbwidth + this.options.thumbgap) * this.options.carouselcolumn: this.options.width) + "px; top:0px; }"), a += " .html5gallery-tn-" + this.id + " { display:block; float:left; margin-left:0px; margin-right:" + this.options.thumbgap + "px; margin-bottom:" + this.options.thumbrowgap + "px; text-align:center; cursor:pointer; width:" + this.options.thumbwidth + "px;height:" + this.options.thumbheight + "px;overflow:hidden;}", this.options.thumbshadow && (a += " .html5gallery-tn-" + this.id + " { -moz-box-shadow: 0px 2px 5px #aaa; -webkit-box-shadow: 0px 2px 5px #aaa; box-shadow: 0px 2px 5px #aaa;}"), a += " .html5gallery-tn-selected-" + this.id + " { display:block; float:left; margin-left:0px; margin-right:" + this.options.thumbgap + "px; margin-bottom:" + this.options.thumbrowgap + "px; text-align:center; cursor:pointer; width:" + this.options.thumbwidth + "px;height:" + this.options.thumbheight + "px;overflow:hidden;}", this.options.thumbshadow && (a += " .html5gallery-tn-selected-" + this.id + " { -moz-box-shadow: 0px 2px 5px #aaa; -webkit-box-shadow: 0px 2px 5px #aaa; box-shadow: 0px 2px 5px #aaa;}"), a += " .html5gallery-tn-" + this.id + " {background-color:" + this.options.thumbimagebordercolor + ";} .html5gallery-tn-" + this.id + " { filter:alpha(opacity=" + Math.round(100 * this.options.thumbopacity) + "); opacity:" + this.options.thumbopacity + "; }  .html5gallery-tn-selected-" + this.id + " { filter:alpha(opacity=100); opacity:1; } ", a += " .html5gallery-tn-img-" + this.id + " {display:block; overflow:hidden; width:" + String(this.options.thumbimagewidth + 2 * this.options.thumbimageborder) + "px;height:" + String(this.options.thumbimageheight + 2 * this.options.thumbimageborder) + "px;}", this.options.thumbunselectedimagebordercolor && (a += " .html5gallery-tn-selected-" + this.id + " {background-color:" + this.options.thumbunselectedimagebordercolor + ";}"), this.options.thumbshowtitle ? (a += " .html5gallery-tn-title-" + this.id + " {display:block; overflow:hidden; float:top; height:" + this.options.thumbtitleheight + "px;width:" + String(this.options.thumbwidth - 2) + "px;line-height:" + this.options.thumbtitleheight + "px;}", a += " .html5gallery-tn-title-" + this.id + this.options.thumbtitlecss) : a += " .html5gallery-tn-title-" + this.id + " {display:none;}", this.carouselHighlight = function() {}) : this.options.showcarousel ? (a += " .html5gallery-car-" + this.id + " { position:absolute; display:block; overflow:hidden; left:" + this.options.carouselLeft + "px; top:" + this.options.carouselTop + "px; width:" + this.options.width + "px; height:" + this.options.carouselHeight + "px;", a = this.options.carouselbgtransparent ? a + "background-color:transparent;": a + ("border-top:1px solid " + this.options.carouseltopborder + ";border-bottom:1px solid " + this.options.carouselbottomborder + ";background-color: " + this.options.carouselbgcolorend + "; background: " + this.options.carouselbgcolorend + " -webkit-gradient(linear, left top, left bottom, from(" + this.options.carouselbgcolorstart + "), to(" + this.options.carouselbgcolorend + ")) no-repeat; background: " + this.options.carouselbgcolorend + " -moz-linear-gradient(top, " + this.options.carouselbgcolorstart + ", " + this.options.carouselbgcolorend + ") no-repeat; filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=" + this.options.carouselbgcolorstart + ", endColorstr=" + this.options.carouselbgcolorend + ") no-repeat; -ms-filter: 'progid:DXImageTransform.Microsoft.gradient(startColorstr=" + this.options.carouselbgcolorstart + ", endColorstr=" + this.options.carouselbgcolorend + ")' no-repeat;"), this.options.carouselbgimage && (a += "background:url('" + this.options.skinfolder + this.options.carouselbgimage + "') center top;"), a += "}", a += " .html5gallery-car-list-" + this.id + " { position:absolute; display:block; overflow:hidden; left:4px; width:" + String(this.options.width - 4 - 4) + "px; top:0px; height:" + this.options.carouselHeight + "px; }", this.options.carouselNavButton = !1, Math.floor((this.options.width - 4 - 4) / (this.options.thumbwidth + this.options.thumbgap)) < this.elemArray.length && (this.options.carouselNavButton = !0), a += " .html5gallery-car-left-" + this.id + " { position:absolute; overflow:hidden; width:" + this.options.carouselarrowwidth + "px; height:" + this.options.carouselarrowheight + "px; left:0px; top:" + String(this.options.carouselHeight / 2 - this.options.carouselarrowheight / 2) + "px; background:url('" + this.options.skinfolder + "carousel_left.png') no-repeat 0px 0px;}  .html5gallery-car-right-" + this.id + " { position:absolute; overflow:hidden; width:" + this.options.carouselarrowwidth + "px; height:" + this.options.carouselarrowheight + "px; right:0px; top:" + String(this.options.carouselHeight / 2 - this.options.carouselarrowheight / 2) + "px; background:url('" + this.options.skinfolder + "carousel_right.png') no-repeat 0px 0px;} ", d = this.options.carouselNavButton ? 2 * this.options.carouselarrowwidth + 8 : 0, b(".html5gallery-car-left-" + this.id).css({
                    ...
                    b(".html5gallery-car-right-" + this.id, this.$gallery).data("disabled", !0);
                        ...
                        c = -c;
                        d ? b(".html5gallery-thumbs-" + this.id, this.$gallery).css({
                            marginLeft: c
            ...
            goFullscreen: function() {
                ...
                b(document).bind("keyup.html5gallery",
                function(a) {
            ...
            slideRun: function(a, d, c, e) {
                ...
                this.calcIndex(a);
                this.options.socialurlforeach && this.createSocialMedia(); ! this.isFullscreen && this.options.showcarousel && (b("#html5gallery-tn-" + this.id + "-" + this.curElem, this.$gallery).removeClass("html5gallery-tn-" + this.id).addClass("html5gallery-tn-selected-" + this.id), !this.options.notupdatecarousel && !this.disableupdatecarousel && this.carouselHighlight(this.curElem));
                ...
                a = this.elemArray[this.curElem][9];
                if (! (0 > a)) { ! this.isFullscreen && d ? "always" == this.options.showimagetoolbox ? ("mouseover" == this.options.imagetoolboxmode || "show" == this.options.imagetoolboxmode) && this.showimagetoolbox(a) : "image" == this.options.showimagetoolbox && 1 != a && this.hideimagetoolbox() : "show" == this.options.imagetoolboxmode ? this.showimagetoolbox(a) : this.hideimagetoolbox();
                    this.onChange();
                    ...
                    this.slideTimerCount = 0,
                    this.options.showtimer && (this.slideTimer = setInterval(function() {
                        g.showSlideTimer()
                    },
                    50));
                    this.options.loop && this.looptimes >= this.options.loop && (this.looptimes = 0, this.pauseGallery());
                    this.elemArray[this.curElem][5] || (this.options.lightbox || this.elemArray[this.curElem][22]) && !this.isFullscreen ? (d.css({
                        cursor: "pointer"
                    }), d.unbind("click").bind("click",
                    function() { (g.options.lightbox || g.elemArray[g.curElem][22]) && !g.isFullscreen ? g.goFullscreen() : g.elemArray[g.curElem][5] && (g.elemArray[g.curElem][6] ? window.open(g.elemArray[g.curElem][5], g.elemArray[g.curElem][6]) : window.open(g.elemArray[g.curElem][5]))
                    })) : (d.css({
                        cursor: ""
                    }), d.unbind("click"))
                }
            ...
            showImage: function() {
                ...
                b(c).load(function() {
                    ...
                    e = b("<div class='html5gallery-elem-img-" + d.id + "' style='display:block; position:absolute; overflow:hidden; width:" + h + "px; height:" + j + "px; left:0px; margin-left:" + (d.options.slideshadow && !d.isFullscreen ? 4 : 0) + "px; top:0px; margin-top:" + (d.options.slideshadow && !d.isFullscreen ? 4 : 0) + "px;'><img class='html5gallery-elem-image-" + d.id + "' style='border:none; position:absolute; opacity:inherit; filter:inherit; padding:0px; margin:0px; left:" + g + "px; top:" + l + "px; max-width:none; max-height:none; width:" + e + "px; height:" + c + "px;' src='" + d.elemArray[d.curElem][2] + "' />" + d.options.watermarkcode + "</div>");
            ...
            showPoster: function() {
                ...
                b(h).load(function() {
                    ...
                    c.isFullscreen && c.adjustFullscreen(g, l);
                    d.css({
                        width: g,
                        height: l
                    });
                    g = b("<div class='html5gallery-elem-img-" + c.id + "' style='display:block; position:absolute; overflow:hidden; width:" + g + "px; height:" + l + "px; left:0px; margin-left:" + (c.options.slideshadow && !c.isFullscreen ? 4 : 0) + "px; top:0px; margin-top:" + (c.options.slideshadow && !c.isFullscreen ? 4 : 0) + "px;'><img class='html5gallery-elem-image-" + c.id + "' style='border:none; position:absolute; opacity:inherit; filter:inherit; padding:0px; margin:0px; left:" + q + "px; top:" + m + "px; max-width:none; max-height:none; width:" + p + "px; height:" + h + "px;' src='" + c.elemArray[c.curElem][12] + "' />" + c.options.watermarkcode + "</div>");
            ...
            showVideo: function(a, d) {
                ...
                if (this.isHTML5) {
                    ...
                    if (this.options.isFirefox || this.options.isOpera || !j) j = this.elemArray[this.curElem][4] ? this.elemArray[this.curElem][4] : this.elemArray[this.curElem][3],
                    g = this.elemArray[this.curElem][15] ? this.elemArray[this.curElem][15] : this.elemArray[this.curElem][14];
                    this.embedHTML5Video(b(".html5gallery-elem-video-" + this.id, c), f, e, j, g, a, h, d)
                } else h = this.elemArray[this.curElem][2],
                "/" != h.charAt(0) && ("http:" != h.substring(0, 5) && "https:" != h.substring(0, 6)) && (h = this.options.htmlfolder + h),
                j = "",
                this.elemArray[this.curElem][13] && (j = this.elemArray[this.curElem][13], "/" != j.charAt(0) && ("http:" != j.substring(0, 5) && "https:" != j.substring(0, 6)) && (j = this.options.htmlfolder + j)),
                this.embedFlash(b(".html5gallery-elem-video-" + this.id, c), "100%", "100%", this.options.jsfolder + "html5boxplayer.swf", "transparent", {
                    width: f,
                    height: e,
            ...
            showYoutube: function(a) {
                ...
                } else f = this.prepareYoutubeHref(f),
                a && (f = 0 > f.indexOf("?") ? f + "?autoplay=1": f + "&autoplay=1"),
            ...
            showIframe: function() {
                ...
                b(".html5gallery-elem-" + this.id, a).html("<div class='html5gallery-loading-center-" + this.id + "'></div><div class='html5gallery-elem-iframe-" + this.id + "' style='display:block;position:absolute;overflow:hidden;top:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;left:" + (this.options.slideshadow && !this.isFullscreen ? 4 : 0) + "px;width:" + c + "px;height:" + d + "px;'></div>" + this.options.watermarkcode);
            ...
            embedHTML5Video: function(a, d, c, e, f, h, j, g) {
                ...
                b("video", a).get(0).setAttribute("src", (f && this.isHd ? f: e) + (0 < j ? "#t=" + j: "")); ! this.options.nativehtml5controls && !this.options.videohidecontrols && (b("video", a).data("src", e), b("video", a).data("hd", f), b("video", a).data("ishd", this.isHd), b("video", a).addHTML5VideoControls(this.options.skinfolder, this, "html5gallery-elem-html5-video-" + this.id)); (h || g) && b("video", a).get(0).play();
                var l = this;
                b("video", a).unbind("ended").bind("ended",
                function() {
                    l.onVideoEnd();
        ...
        this.each(function() {
            ...
            if ((!b(this).data("donotinit") || l && l.forceinit) && !b(this).data("inited")) {
                ...
                k = b(window).width();
                if (this.options.screenquery) for (d in this.options.screenquery) k <= this.options.screenquery[d].screenwidth && (this.options.screenquery[d].gallerywidth && (this.options.width = this.options.screenquery[d].gallerywidth), this.options.screenquery[d].galleryheight && (this.options.height = this.options.screenquery[d].galleryheight), this.options.screenquery[d].thumbwidth && (this.options.thumbwidth = this.options.screenquery[d].thumbwidth), this.options.screenquery[d].thumbheight && (this.options.thumbheight = this.options.screenquery[d].thumbheight));
...
function HTML5GallerySWFObjectFunc() {
    ...
    function v() {
        ...
        if (0 < b) for (var d = 0; d < b; d++) {
            ...
            if (0 < r.pv[0]) {
                var k = e(g);
                if (k) if (a(I[d].swfVersion) && !(r.wk && 312 > r.wk)) c(g, !0),
                h && (j.success = !0, j.ref = x(g), h(j));
                    ...
                    for (var m = {},
                    k = k.getElementsByTagName("param"), n = k.length, p = 0; p < n; p++)"movie" != k[p].getAttribute("name").toLowerCase() && (m[k[p].getAttribute("name")] = k[p].getAttribute("value"));
                    B(j, m, g, h)
                } else l(k),
                h && h(j)
            } else if (c(g, !0), h) {
                if ((g = x(g)) && typeof g.SetVariable != f) j.success = !0,
                j.ref = g;
                h(j)
            }
        }
    ...
    function q() {
        return ! D && a("6.0.65") && (r.win || r.mac) && !(r.wk && 312 > r.wk)
    }
    function B(a, c, d, h) {
        D = !0;
        u = h || null;
        ...
        if (j) {
            ...
            h = "MMredirectURL=" + t.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + h + "&MMdoctitle=" + p.title;
            c.flashvars = typeof c.flashvars != f ? c.flashvars + ("&" + h) : h;
            r.ie && (r.win && 4 != j.readyState) && (h = p.createElement("div"), d += "SWFObjectNew", h.setAttribute("id", d), j.parentNode.insertBefore(h, j), j.style.display = "none",
            function() {
    ...
    function b(a) {
        ...
        else if (a = a.getElementsByTagName(h)[0]) if (a = a.childNodes) for (var c = a.length,
    ...
    function G(a, b, c) {
        ...
        if (g) if (typeof a.id == f && (a.id = c), r.ie && r.win) {
            ...
            for (var q in a) a[q] != Object.prototype[q] && ("styleclass" == q.toLowerCase() ? m.setAttribute("class", a[q]) : "classid" != q.toLowerCase() && m.setAttribute(q, a[q]));
    ...
    function d(a, b, c, d) {
        if (!r.ie || !r.mac) {
            ...
            if (e) {
                ...
                d && (T = A = null);
                if (!A || T != c) d = p.createElement("style"),
                d.setAttribute("type", "text/css"),
                d.setAttribute("media", c),
                A = e.appendChild(d),
                r.ie && (r.win && typeof p.styleSheets != f && 0 < p.styleSheets.length) && (A = p.styleSheets[p.styleSheets.length - 1]),
                T = c;
    ...
    C = !0,
    r,
    W = typeof p.getElementById != f && typeof p.getElementsByTagName != f && typeof p.createElement != f,
    ...
    if (typeof H.plugins != f && typeof H.plugins["Shockwave Flash"] == h) {
        if ((y = H.plugins["Shockwave Flash"].description) && !(typeof H.mimeTypes != f && H.mimeTypes[j] && !H.mimeTypes[j].enabledPlugin)) V = !0,
        L = !1,
        y = y.replace(/^.*\s+(\S+\s+\S+$)/, "$1"),
        F[0] = parseInt(y.replace(/^(.*)\..*$/, "$1"), 10),
        F[1] = parseInt(y.replace(/^.*\.(.*)\s.*$/, "$1"), 10),
        F[2] = /[a-zA-Z]/.test(y) ? parseInt(y.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
    } else if (typeof t.ActiveXObject != f) try {
        var M = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
        if (M && (y = M.GetVariable("$version"))) L = !0,
        y = y.split(" ")[1].split(","),
    ...
    r.w3 && ((typeof p.readyState != f && "complete" == p.readyState || typeof p.readyState == f && (p.getElementsByTagName("body")[0] || p.body)) && s(), z || (typeof p.addEventListener != f && p.addEventListener("DOMContentLoaded", s, !1), r.ie && r.win && (p.attachEvent("onreadystatechange",
    function() {
    ...
    r.ie && r.win && window.attachEvent("onunload",
    function() {
        for (var a = O.length,
        b = 0; b < a; b++) O[b][0].detachEvent(O[b][1], O[b][2]);
        a = n.length;
        for (b = 0; b < a; b++) S(n[b]);
    ...
    return {
        ...
        embedSWF: function(b, d, e, g, j, k, l, m, n, p) {
            ...
            r.w3 && !(r.wk && 312 > r.wk) && b && d && e && g && j ? (c(d, !1), w(function() {
                ...
                if (l && typeof l === h) for (var v in l) s.flashvars = typeof s.flashvars != f ? s.flashvars + ("&" + v + "=" + l[v]) : v + "=" + l[v];
                if (a(j)) u = G(r, s, d),
                r.id == d && c(d, !0),
                t.success = !0,
                t.ref = u;
        ...
        getQueryParamValue: function(a) {
            ...
            if (b) { / \ ? /.test(b)&&(b=b.split("?")[1]);if(null==a)return k(b);for(var b=b.split("&"),c=0;c<b.length;c++)if(b[c].substring(0,b[c].indexOf("="))==a)return k(b[c].substring(b[c].indexOf("=")+1))}return""},expressInstallCallback:function(){if(D){var a=e(g);a&&P&&(a.parentNode.replaceChild(P,a),J&&(c(J,!0),r.ie&&r.win&&(P.style.display="block")),u&&u(Q));D=!1}}}}
