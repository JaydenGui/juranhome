...
(function(d, J, K) {
    function P(a, b, d, l, j, h, c, n, q) {
        ...
        D = r.length - 1; 0 <= D; D--) {
            ...
            Q[d] = c ? !0 === q || !0 === G && !1 !== q && L ? "translate3d(" + n.left + "px, " + n.top + "px, 0)": "translate(" + n.left + "px," + n.top + "px)": h;
            x[F] = (x[F] ? x[F] + ",": "") + d;
            x[y] = (x[y] ? x[y] + ",": "") + l + "ms";
            x[e] = (x[e] ? x[e] + ",": "") + j
        }
    ...
    O = void 0 !== z.WebkitTransition || void 0 !== z.MozTransition || void 0 !== z.OTransition || void 0 !== z.transition,
    ...
    d.fn.animate = function(a, b, p, l) {
        ...
        t;
        if (! (t = !0 === ("undefined" !== typeof a.avoidCSSTransitions ? a.avoidCSSTransitions: C))) if (! (t = !O)) if (! (t = B(a))) {
            var k;
            a: {
        ...
        return t ? J.apply(this, arguments) : this[!0 === h.queue ? "queue": "each"](function() {
                ...
                if (2 == c.eventPhase) {
                    if (!0 !== a.leaveTransforms) {
                        ...
                        if (j && "undefined" !== typeof g.meta) {
                            c = 0;
                            for (var e; e = I[c]; ++c) f[e] = g.meta[e + "_o"] + "px",
                            d(this).css(e, f[e])
                        }
                    }
            ...
            for (e in a) if ( - 1 === d.inArray(e, T)) {
                ...
                if ("d" == u) m = void 0;
                    ...
                    "bottom" == u && (s = parseInt(m, 10) + v.y); ! f && "show" == w ? (s = 1, t && g.css({
