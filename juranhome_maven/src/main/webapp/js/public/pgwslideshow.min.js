...
(function(a) {
    a.fn.pgwSlideshow = function(q) {
        ...
        var g = function() {
            ...
            j.plugin = j.plugin.parent(); 
            j.plugin.prepend('<div class="ps-current"><ul></ul><span class="pgarrow" style="margin:0 auto;display:none;padding-top: 13px;border-bottom:1px solid rgba(255,255,255,.15);height:38px;"><img src='+imagesUrl+' /></span><span class="qp-ps-caption"><a href="#windowImg" data-dismiss="modal" data-toggle="modal" data-target="#windowImg">点击全屏查看</a></span></div>');
